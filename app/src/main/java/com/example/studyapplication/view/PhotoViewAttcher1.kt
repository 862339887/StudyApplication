...
class PhotoViewAttcher1(var imageView: MultifunctionPhotoView1) : OnTouchListener,
    ...
    var mZoomDuration = DEFAULT_ZOOM_DURATION
    var mMinScale = DEFAULT_MIN_SCALE
    var mMidScale = DEFAULT_MID_SCALE
    var mMaxScale = DEFAULT_MAX_SCALE
    var mScale = -1F
...
//        if (imageView.judgeIsClipPhoto(ev)) {
//            return false
//        }
        var handled = false
    ...
    inner class AnimatedZoomRunnable(
        ...
        init {
            ...
            imageView.setOnTouchListener(this@PhotoViewAttcher1)
            imageView.addOnLayoutChangeListener(this@PhotoViewAttcher1)
            if (!imageView.isInEditMode) {
                ...
                mGestureDetector!!.setOnDoubleTapListener(object :
